...
namespace Models.ViewModels.Services.S3
{
    public class DownloadS3Response : SimpleS3Response
    {
        ...
        public DownloadS3Response(HttpStatusCode status, string message, byte[] data, IReadOnlyDictionary<string, string> metaData, string contentType, string title) : base(status, message)
        {
            Data = data;
            MetaData = metaData;
